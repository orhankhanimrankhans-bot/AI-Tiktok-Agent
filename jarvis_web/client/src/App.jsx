...
function FacebookCredentialModal({ canManageMeta, onClose, credential, onStartOAuth, onDisconnect, onTestAccessToken, onSaveAccessToken, onDeleteAccessToken, onCredentialsChanged }) {
  ...
  return (
    <div className="credential-modal-overlay">
      <div className="credential-modal facebook-account-modal">
        <header className="credential-modal-header">
        ...
        <div className="credential-modal-body">
          ...
          <section className="credential-content">
            ...
            <section className="facebook-account-connection" aria-label="Facebook account connection"><div className="credential-content-top"><div><span className="connection-eyebrow">02 / FACEBOOK ACCOUNT</span><h3>Setup credential</h3></div><select aria-label="Authentication type" value={authMode} onChange={(event) => { setAuthMode(event.target.value); setAccessToken(""); setConnectionState("not_tested"); setConnectionMessage(""); }} disabled={Boolean(credential)}><option value="managed_oauth2">Use my own Meta App</option><option value="manual_access_token">Access Token</option></select></div>
            {!isManual && <>{credential ? <div className="facebook-account-status is-connected" role="status"><span className="connection-state-icon" aria-hidden="true">&#10003;</span><div className="connection-status-copy"><strong>Connected</strong><span>{credential.accountName || credential.accountId}</span></div><button type="button" className="disconnect-button" onClick={disconnect}>Disconnect</button></div> : <div className="facebook-account-status is-disconnected" role="status"><span className="connection-state-icon" aria-hidden="true">!</span><div className="connection-status-copy"><strong>Not Connected</strong><span>Connect your Facebook account to use its Pages.</span></div></div>}<p className="connection-security-note">Meta OAuth tokens and Page tokens are encrypted and stored only by the Corex backend.</p>{connectionMessage && <div className="credential-backend-status" role="status">{connectionMessage}</div>}</>}
  ...
  const applySimpleTheme = (theme) => {
    if (theme === "light") {
      updateAppearance({
        ...
        nodeBorder: "#aac4d0",
        nodeBorderSuccess: "#21a966",
        nodeBorderError: "#d84555",
        nodeBorderDisconnected: "#9aabb5",
        nodeBorderRunning: "#0894ad",
        nodeTitle: "#13222b",
        nodeSubtitle: "#5f737e",
        iconBackground: "#e8f7fa",
        iconTint: "#087f9a",
        connectedLight: "#1daf72",
        disconnectedLight: "#9aabb5",
        errorLight: "#d84555",
        connectorColor: "#3b8ea1",
        wireIdle: "#3b8ea1",
        wireRunning: "#0894ad",
        wireSuccess: "#21a966",
        wireError: "#d84555",
        dashboardBackground: "#f6f8fb",
        dashboardPanel: "#ffffff",
        dashboardBorder: "#c7d8e1",
        dashboardHeading: "#14212a",
        dashboardText: "#24313a",
        dashboardMuted: "#60717d",
        dashboardCard: "#ffffff",
        dashboardRoute: "#c69a2d",
        dashboardCore: "#0894ad",
        engineReady: "#c69a2d",
        engineRunning: "#21a966",
        engineError: "#d84555",
        engineDisconnected: "#9aabb5",
        conversationPanel: "#ffffff",
        conversationUser: "#e8f7fa",
        conversationJarvis: "#eaf7ef",
        conversationInput: "#ffffff",
        dashboardIcon: "#087f9a",
      ...
      updateAppearance({
        ...
        canvasColorB: "#102a43",
        headerColor: "#171d22",
        headerTextColor: "#f4f7f9",
        statusTextColor: "#9aacb3",
        headerBorderColor: "#2d424b",
        sidebarBackground: "#101518",
        sidebarText: "#aebbc1",
        sidebarActiveText: "#e9fcff",
        sidebarIcon: "#79dce9",
        sidebarActiveBackground: "#123442",
        sidebarBorder: "#24343b",
        controlBackground: "#20282d",
        controlText: "#e9f9fb",
        controlAccent: "#37d9ee",
        controlBorder: "#46545b",
        controlHover: "#34434a",
        mainText: "#eefcff",
        mutedText: "#83969e",
        panelBackground: "#10171b",
        panelBorder: "#33474f",
        nodeBackground: "#1a2024",
        nodeBorder: "#52636b",
        nodeBorderSuccess: "#3dff91",
        nodeBorderError: "#ff4d5f",
        nodeBorderDisconnected: "#ffffff",
        nodeBorderRunning: "#37d9ee",
        nodeTitle: "#f8fdff",
        nodeSubtitle: "#bdcbd1",
        iconBackground: "#182b33",
        iconTint: "#9af2ff",
        connectedLight: "#3dff91",
        disconnectedLight: "#ffffff",
        errorLight: "#ff4d5f",
        connectorColor: "#78878e",
        wireIdle: "#647078",
        wireRunning: "#31d9b0",
        wireSuccess: "#3aa76d",
        wireError: "#e45d68",
              ...
              <div className="editor-layout">
                ...
                >
                  ...
                  <div className="canvas-command-tools" onPointerDown={(event) => event.stopPropagation()}>
                    ...
                    <button type="button" onClick={() => { setShowNodePicker(true); setTimeout(() => document.querySelector('.node-search')?.focus(), 0); }} title="Search nodes" aria-label="Search nodes">Search</button>
