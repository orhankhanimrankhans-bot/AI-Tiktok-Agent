...
function publicMetrics(row) { return row ? { followers: row.followers ?? null, views: row.views ?? null, posts: row.posts ?? row.reels ?? null, reels: row.reels ?? row.posts ?? null, engagement: row.engagement ?? null, followerGrowth: row.follower_growth ?? null, capturedAt: row.captured_at || null } : { followers: null, views: null, posts: null, reels: null, engagement: null, followerGrowth: null, capturedAt: null }; }
