...
function publicPage(row, metrics = null) { return row && { id: row.id, pageUrl: row.page_url, pageName: row.page_name, pageId: row.page_id || "", teamMemberId: row.team_member_id || "", teamMemberName: row.team_member_name || "Unassigned", credentialId: row.credential_id || "", status: row.status, dataConnectionStatus: row.data_connection_status, lastSyncAt: row.last_sync_at || null, notes: row.notes || "", createdAt: row.created_at, updatedAt: row.updated_at, metrics: metrics || { followers: null, views: null, reels: null, engagement: null, followerGrowth: null, capturedAt: null } }; }
